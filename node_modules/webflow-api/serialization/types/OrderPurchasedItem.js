...
exports.OrderPurchasedItem = core.serialization.object({
    ...
    rowTotal: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).OrderPrice; })).optional(),
    ...
    variantImage: core.serialization
        ...
        .optional(),
    variantPrice: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).OrderPrice; })).optional(),
